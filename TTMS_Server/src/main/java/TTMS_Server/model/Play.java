...
public class Play {
    ...
    public Play(Integer play_type_id, Integer play_lang_id, String play_name, String play_introduction, Integer play_length, BigDecimal play_ticket_price, Short play_status) {
        this.play_type_id = play_type_id;
        this.play_lang_id = play_lang_id;
        this.play_name = play_name;
        this.play_introduction = play_introduction;
