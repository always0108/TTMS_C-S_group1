...
public class Studio {
    ...
    public Studio(String studio_name,Integer studio_row_count, Integer studio_col_count,Integer studio_seat_count,String studio_introduction,Short studio_flag){
